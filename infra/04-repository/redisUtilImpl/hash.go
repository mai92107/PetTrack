...
func (myCache *redisRepoImpl) HGetData(ctx context.Context, key, field string) string {
...
func (myCache *redisRepoImpl) HGetAllData(ctx context.Context, key string) map[string]string {
